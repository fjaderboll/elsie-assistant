...
class AudioProcessor:
	...
	def record_audio(self, timeout=15, calibration_duration=1, phrase_time_limit=None):
		try:
			with sr.Microphone() as source:
				...
				wave_data = audio_data.get_wav_data(convert_rate=16000, convert_width=2)
				return wave_data
		except sr.WaitTimeoutError:
			logging.warning(f"Listening timed out")
			return None
